...
export const APPEND_DISTANCE = "APPENDDISTANCE"
...
export const RECORD_DURATION = "RECORDDURATION"
...
export const appendDistance = (payload: number) => ({
    type: APPEND_DISTANCE,
    payload,
})
...
export const recordDuration = (payload: number) => ({
    type:RECORD_DURATION,
    payload
})